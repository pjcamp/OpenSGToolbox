...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of an impulse force");
    ...
    DocForeground->addLine("       \\{\\color=AAAAFFFF e}: Apply explosion");
    DocForeground->addLine("     \\{\\color=AAAAFFFF 1-6}: Apply explosion. 1: Low force, 6: high force");
