...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of \\{\\color=AAAA00FF FieldContainerEditorComponent} and");
    DocForeground->addLine("\\{\\color=AAAA00FF FieldContainerEditorFactory}.");
    
    DocForeground->addLine("");
    DocForeground->addLine("\\{\\color=AAAAAAFF Key Controls}:");
    DocForeground->addLine("     \\{\\color=AAAAFFFF Cmd+e}: Open editor for viewport");
