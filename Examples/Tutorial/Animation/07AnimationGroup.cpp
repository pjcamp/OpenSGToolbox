...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of a \\{\\color=AAAA00FF AnimationGroup}.");
    ...
    DocForeground->addLine("         \\{\\color=AAAAFFFF +}: Increase animation rate");
    DocForeground->addLine("         \\{\\color=AAAAFFFF -}: Decrease animation rate");
