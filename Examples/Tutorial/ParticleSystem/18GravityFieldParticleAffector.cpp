...
void keyTyped(KeyEventDetails* const details,
              ...
              GravityParticleAffector* const ExampleGravityAffector
             )
{
    ...
    switch(details->getKey())
    {
        ...
        case KeyEventDetails::KEY_MINUS:
            ExampleGravityAffector->setMagnitude(osgClamp<Real32>(1.0f,ExampleGravityAffector->getMagnitude() * 0.8,TypeTraits<Real32>::getMax())); 
            break;
        case KeyEventDetails::KEY_PLUS:
        case KeyEventDetails::KEY_EQUALS:
            ExampleGravityAffector->setMagnitude(osgClamp<Real32>(1.0f,ExampleGravityAffector->getMagnitude() * 1.2,TypeTraits<Real32>::getMax())); 
            break;
    }
}
...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of a \\{\\color=AAAA00FF GravityParticleAffector}.");
    
    DocForeground->addLine("");
    DocForeground->addLine("\\{\\color=AAAAAAFF Key Controls}:");
    DocForeground->addLine("         \\{\\color=AAAAFFFF +}: Increase gravity");
    DocForeground->addLine("         \\{\\color=AAAAFFFF -}: Decrease gravity");
...
int main(int argc, char **argv)
{
...

    {
        ...
        GravityParticleAffectorRecPtr ExampleGravityAffector = GravityParticleAffector::create();
        ...
        NodeRefPtr GravityBeacon = Node::create();
