...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("This tutorial is a simple demonstration of the");
    DocForeground->addLine("creation of an explosion effect.");
    
    DocForeground->addLine("");
    DocForeground->addLine("\\{\\color=AAAAAAFF Key Controls}:");
    DocForeground->addLine("         \\{\\color=AAAAFFFF 1}: Cycle image sequence forward");
    DocForeground->addLine("         \\{\\color=AAAAFFFF 2}: Cycle image sequence in reverse");
    DocForeground->addLine("         \\{\\color=AAAAFFFF 3}: Cycle image sequence in custom sequence");
