...
void keyTyped(KeyEventDetails* const details,
              ...
              AttributeParticleFunction* const AttributeFunc
             )
{
...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of a \\{\\color=AAAA00FF QuadSequenceParticleSystemDrawer} base on the");
    DocForeground->addLine("particle attributes.");
    
    DocForeground->addLine("");
    DocForeground->addLine("\\{\\color=AAAAAAFF Key Controls}:");
    DocForeground->addLine("         \\{\\color=AAAAFFFF 1}: Use direct sequence order");
    DocForeground->addLine("         \\{\\color=AAAAFFFF 2}: Use custom sequence order");
...
int main(int argc, char **argv)
{
...

    {
        ...
        AttributeParticleFunctionRecPtr AttributeFunc = AttributeParticleFunction::create();
        AttributeFunc->setSequenceOrder(AttributeParticleFunction::DIRECT); 
