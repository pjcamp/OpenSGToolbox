...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of a \\{\\color=AAAA00FF UniformParticleAffector}.");
    ...
    DocForeground->addLine("         \\{\\color=AAAAFFFF r}: Reverse magnitude of the force");
    DocForeground->addLine("         \\{\\color=AAAAFFFF a}: Set direction to {-1.0, 0.0, 0.0}");
    DocForeground->addLine("         \\{\\color=AAAAFFFF w}: Set direction to { 0.0, 1.0, 0.0}");
    DocForeground->addLine("         \\{\\color=AAAAFFFF s}: Set direction to { 0.0,-1.0, 0.0}");
    DocForeground->addLine("         \\{\\color=AAAAFFFF d}: Set direction to { 1.0, 0.0, 0.0}");
