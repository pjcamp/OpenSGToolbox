...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of a \\{\\color=AAAA00FF DistanceAttractRepelParticleAffector}.");
...
int main(int argc, char **argv)
{
...

    {
        ...
        DiscParticleSystemDrawerRefPtr ExampleParticleSystemDrawer = DiscParticleSystemDrawer::create();
        ...
        sceneManager.getNavigator()->set(Pnt3f(0.0,0.0,500.0), Pnt3f(0.0,0.0,0.0), Vec3f(0.0,1.0,0.0));
        sceneManager.getNavigator()->setMotionFactor(1.0f);
        sceneManager.getCamera()->setNear(0.1f);
        sceneManager.getCamera()->setFar(1000.0f);

        DistanceAttractRepelParticleAffectorRefPtr ExampleDistanceAttractRepelParticleAffector = DistanceAttractRepelParticleAffector::create();
